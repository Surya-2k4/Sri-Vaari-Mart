...
class ReceiptGeneratorService {
  static final ReceiptGeneratorService _instance =
      ReceiptGeneratorService._internal();

  factory ReceiptGeneratorService() {
    return _instance;
  }

  ReceiptGeneratorService._internal();

  Future<void> generateReceipt(AdminOrderModel order) async {
